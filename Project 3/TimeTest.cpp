...
void measure_time(int(*HashFunction)(int, int), const int size, const int loadfactor, const int scenario, bool (T::*operation)(Arg), Arg key, const std::filesystem::path& output_csv) {
    Timer timer;
    ...
    for (int i = 0; i < repeats; ++i) {
        ...
        HashTable.load(size, loadfactor, scenario);
        timer.start();
